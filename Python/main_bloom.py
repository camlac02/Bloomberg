...
def return_values(str_fields, str_tickers, date_start, date_end, str_strategie, str_optimisation, str_rebelancement, str_generic, str_options, str_frais):
    ...
    with open('json_perfs' + str_nomfichier + '.json', "w") as file_f:
        jsonperfs = json.dump(json_perfs, file_f)
...
if __name__ == '__main__':
    return_json("PX_LAST, INDX_MWEIGHT_HIST", "CAC Index", dt.datetime(2015, 1, 2), dt.datetime(2023, 1, 2), "Value", "min_variance", '22', 'False', '25, 250, CUR_MKT_CAP', '0.0002')
